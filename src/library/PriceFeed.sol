...
import {AAggregatorV3Interface} from "@chainlink/contracts/src/v0.8/shared/interfaces/AggregatorV3Interface.sol";
...
library PriceFeed {
    ...
    function getLatestPriceETH_USD() internal view returns (int256) {
        if (priceFeedAddress == address(0)) {
            revert PriceFeed__InvalidPriceFeedAddress();
        }

        AAggregatorV3Interface priceFeed = AAggregatorV3Interface(priceFeedAddress);
